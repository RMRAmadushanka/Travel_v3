        ...
        >
          {({ values, setFieldValue, errors }) => {
            ...
            <Form className="space-y-6">
              <div>
                <Label>Name</Label>
                <Field name="name" className="border p-3 rounded-md w-full bg-white dark:bg-neutral-900 dark:border-neutral-700"/>
                <ErrorMessage name="name" component="div" className="text-red-500 text-sm mt-1" />
              </div>

              <div>
                <Label>Email</Label>
                <Field name="email" type="email" className="border p-3 rounded-md w-full bg-white dark:bg-neutral-900 dark:border-neutral-700"/>
              ...
              <div>
                ...
                <Field name="arrivalDate" type="date" className="border p-3 rounded-md w-full bg-white   text-black "/>
                <ErrorMessage name="arrivalDate" component="div" className="text-red-500 text-sm mt-1" />
              </div>

              <div>
                <Label>Pickup Place</Label>
                <Field name="pickupPlace" className="border p-3 rounded-md w-full bg-white dark:bg-neutral-900 dark:border-neutral-700"/>
                <ErrorMessage name="pickupPlace" component="div" className="text-red-500 text-sm mt-1" />
              </div>
              ...
              <div>
                ...
                <Field name="groupSize" type="number" min="1" className="border p-3 rounded-md w-full bg-white dark:bg-neutral-900 dark:border-neutral-700"/>
                <ErrorMessage name="groupSize" component="div" className="text-red-500 text-sm mt-1" />
              </div>
                      ...
                      {(values.days || []).map((day, index) => (
                        ...
                        >
                          ...
                          <Field
                            ...
                            type="date"
                            className="border p-3 rounded-md w-full mt-1.5  text-black"
                          />
                          <ErrorMessage
                            name={`days[${index}].date`}
                            component="div"
